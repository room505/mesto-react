			...
			<div>
				<section className='popup popup_type_edit-profile'>
					<div className='popup__container'>
						...
						<form className='popup__form popup__form_type_edit-profile' id='editProfile' name='editProfile' noValidate=''>
				...
				<section className='popup popup_type_add-card'>
					<div className='popup__container'>
						...
						<button className='popup__close' type='button' />
						<form className='popup__form popup__form_type_add-card' id='addCard' name='addCard' noValidate=''>
							<label className='popup__filed'>
								<input
									type='text'
				...
				<section className='popup popup_delete-card'>
					<div className='popup__container'>
						...
						<button className='popup__close' type='button' />
						<form className='popup__form popup__form_delete-card' id='delete-card' name='delete-card' noValidate=''>
							<button className='popup__save-edit popup__save-edit_delete-card' type='submit'>
								Да
							</button>
						</form>
					</div>
				...
				<section className='popup popup_type_edit-avatar'>
					<div className='popup__container'>
						...
						<button className='popup__close' type='button' />
						<form className='popup__form popup__form_type_edit-avatar' id='editAvatar' name='editAvatar' noValidate=''>
							<label className='popup__filed'>
								<input
									type='url'
									className='popup__text-input popup__text-input_photo-link'
